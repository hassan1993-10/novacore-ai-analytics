...
st.markdown(
    ...
    *{font-family:"Segoe UI",Arial,Tahoma,sans-serif}
    ...
    .message-text.rtl,.message-text.rtl *{
    ...
    .message-text.ltr,.message-text.ltr *{
    ...
    [data-testid="stChatMessage"],[data-testid="stChatMessageContent"]{min-width:0!important;max-width:100%!important;overflow:hidden!important}
    ...
    @media(max-width:640px){
        ...
        .message-text.rtl,.message-text.rtl *{font-size:16px!important;line-height:2.05!important}
        .message-text.ltr,.message-text.ltr *{font-size:15px!important;line-height:1.75!important}
