    ...
    if q:
        ...
        with st.spinner("Analyzing your data..."):
            try:
                ...
                # Temporary diagnostic logging: full error goes to Streamlit Logs.
                print("\n=== NOVACORE COPILOT ERROR ===")
                traceback.print_exc()
                print("=== END NOVACORE COPILOT ERROR ===\n")

                answer="تعذر الاتصال بـ GitHub Copilot حاليًا. راجع سجل التطبيق." if is_ar(q) else "Could not connect to GitHub Copilot. Check the app logs."
